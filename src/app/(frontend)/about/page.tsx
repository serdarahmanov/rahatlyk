...
export default async function AboutPage() {
  ...
  try {
    const [heroRaw, whoWeAreRaw, storyRaw, numbersRaw, certsRaw] = await Promise.all([
      ...
      (payload.findGlobal as any)({ slug: 'about-hero',         locale, depth: 1 }),
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      (payload.findGlobal as any)({ slug: 'about-who-we-are',   locale, depth: 1 }),
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      (payload.findGlobal as any)({ slug: 'about-our-story',    locale, depth: 1 }),
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      (payload.findGlobal as any)({ slug: 'about-numbers',      locale, depth: 1 }),
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
