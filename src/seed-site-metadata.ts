...
const DATA = {
  en: {
    ...
    about:     { title: 'About Us',                        description: "About RAHATLYK — our story, values and the team behind Turkmenistan's premium beverage brand." },
  ...
  tm: {
    ...
    about:     { title: 'Biz hakda',                       description: 'RAHATLYK hakda — taryhymyz, gymmatlyklarymyz we Türkmenistanyň premium içgi brendiniň topary.' },
  ...
  ru: {
    ...
    about:     { title: 'О компании',                      description: 'О компании RAHATLYK — наша история, ценности и команда за брендом премиальных напитков.' },
